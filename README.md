...
| `guardrails` spent all income when income ≥ planned spending                                                              | Surplus pension was consumed rather than invested, unlike `fixed` and `percentOfPortfolio`                                                             | Fixed 2026-08-06 — TODO 0.28                                                                                                                                                                        |
